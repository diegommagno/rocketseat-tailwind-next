      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Diego" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="email"
              className="text-sm font-medium text-zinc-500 dark:text-zinc-100"
            >
              Email address
            </label>
            <Input.Root>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                id="bio"
                defaultValue="I'm a Software Engineer based in the UK. I specialise in Front-end development, brand strategy, and WordPress development."
              />
            </div>
          </div>
